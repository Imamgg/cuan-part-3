        ...
        <section className="w-full px-10" id="albumFoto">
            ...
            <div className="flex">
                ...
                <div className="w-2/3 pl-6">
                    <img className="w-full h-full object-cover rounded-4xl" src="https://imgs.search.brave.com/nJ2Beh3qyiTaTjrfza_GczYmTErUqZUnM8-Ufe98y9c/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/cGl4YWJheS5jb20v/cGhvdG8vMjAyMi8w/Mi8xOS8wNi80OS9y/aWNlLWZpZWxkLTcw/MjE5OTdfNjQwLmpw/Zw" alt="gambar" />
                </div>
            </div>
        </section>
        </>
